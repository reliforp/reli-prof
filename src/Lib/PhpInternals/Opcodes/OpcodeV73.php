...
/** @psalm-immutable */
final class OpcodeV73 implements Opcode
{
    ...
    public const ZEND_FUNC_NUM_ARGS = 194;
    public const ZEND_FUNC_GET_ARGS = 195;
    public const ZEND_UNSET_CV = 196;
    public const ZEND_ISSET_ISEMPTY_CV = 197;
    public const ZEND_FETCH_LIST_W = 198;
