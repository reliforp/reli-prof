...
> **This is a historical design document.** For current usage, see [docs/monitoring/watch-command.md](../monitoring/watch-command.md). For implementation details, see [docs/internals/](./).
...
- User documentation: [docs/monitoring/watch-command.md](../monitoring/watch-command.md)
...
- Container deployment: [docs/monitoring/watch-command.md#container-deployment](../monitoring/watch-command.md#container-deployment)
