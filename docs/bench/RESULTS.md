...
Source: [`docs/bench/results/jit.csv`](results/jit.csv) and
[`docs/bench/results/jit-summary.txt`](results/jit-summary.txt).
...
Source: [`docs/bench/results/raw.csv`](results/raw.csv),
[`docs/bench/results/long.csv`](results/long.csv).
...
Source: [`docs/bench/results/cpu-rates.csv`](results/cpu-rates.csv).
...
Source: [`docs/bench/results/cpu.csv`](results/cpu.csv).)
...
Source: [`docs/bench/results/cpu-samples.csv`](results/cpu-samples.csv).
...
[`docs/bench/results/realworld.csv`](results/realworld.csv) for the
raw numbers.)
...
Source: [`docs/bench/results/realworld.csv`](results/realworld.csv).
...
Source: [`docs/bench/results/output-sizes.csv`](results/output-sizes.csv),
generated by [`docs/bench/run-output-sizes.sh`](run-output-sizes.sh).
...
[`docs/bench/results/cpu-samples.csv`](results/cpu-samples.csv) and
[`docs/bench/results/cpu-rates.csv`](results/cpu-rates.csv) for
reference.
...
[`docs/bench/README.md`](README.md). The Dockerfile in this directory
